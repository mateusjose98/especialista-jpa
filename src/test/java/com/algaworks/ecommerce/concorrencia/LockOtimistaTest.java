...
public class LockOtimistaTest {
    ...
    public void usarLockOtimista() {
        Runnable runnable1 = () -> {
            ...
            esperar(3);
            String user1 = "[Runnable 01] Descrição detalhada.";
            ...
            try {
                ...
                log("Erro ao deletar ou atualizar o registro " + 1 + "a entidade está em uso em outra transação.");
            }
        ...
        Runnable runnable2 = () -> {
            ...
            String user2 = "[Runnable 02] Descrição massa!";
        ...
        Assert.assertEquals("[Runnable 02] Descrição massa!", produto.getDescricao());
